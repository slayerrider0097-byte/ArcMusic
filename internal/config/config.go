...
func loadConfig() {
	...
	SupportChat = getString("SUPPORT_CHAT", "https://t.me/+571PcuJAHeU0MTU1")
	SupportChannel = getString("SUPPORT_CHANNEL", "https://t.me/+xHz3OmQTHSI0Mzk1")
	...
	StartImage = getString(
		"START_IMG_URL",
		"https://files.catbox.moe/ejxqm0.jpg",
	)
	PingImage = getString(
		"PING_IMG_URL",
		"https://files.catbox.moe/ejxqm0.jpg",
